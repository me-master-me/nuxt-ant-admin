...
const resizeListeners = '__resizeListeners__'
const ro = '__ro__'
  ...
  methods: {
    ...
    addResizeListener  (element, fn) {
      ...
      if (!element[resizeListeners]) {
        ...
        element[ro] = new ResizeObserver(this.resizeHandler)
        element[ro].observe(element)
      }
      element[resizeListeners].push(fn)
    },
    removeResizeListener  (element, fn) {
      if (!element?.[resizeListeners]) { return }
    ...
    init (options) {
      ...
      if (this.autoresize) {
        ...
        this.addResizeListener(this.$el, this.__resizeHandler)
      }
    ...
    destroy () {
      if (this.autoresize) {
        this.removeResizeListener(this.$el, this.__resizeHandler)
      }
      this.dispose()
      this.chart = null
    },
